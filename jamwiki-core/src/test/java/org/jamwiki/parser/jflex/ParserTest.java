...
public class ParserTest extends JAMWikiUnitTest {
	...
	public void testSubst() throws Throwable {
		...
		Topic topic1 = WikiBase.getDataHandler().lookupTopic(VIRTUAL_WIKI_NAME, TOPIC1_NAME, false, null);
		String contents1 = ParserUtil.parseMinimal(this.parserInput(TOPIC1_NAME), topic1.getTopicContent());
		Topic topic2 = WikiBase.getDataHandler().lookupTopic(VIRTUAL_WIKI_NAME, TOPIC2_NAME, false, null);
