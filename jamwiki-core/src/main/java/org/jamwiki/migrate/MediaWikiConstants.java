...
public final class MediaWikiConstants {
	...
	static {
		NAMESPACE_CONVERSION_MAP.put(MEDIAWIKI_TALK_NAMESPACE_ID, Namespace.COMMENTS.getLabel());
		NAMESPACE_CONVERSION_MAP.put(MEDIAWIKI_USER_NAMESPACE_ID, Namespace.USER.getLabel());
		NAMESPACE_CONVERSION_MAP.put(MEDIAWIKI_USER_TALK_NAMESPACE_ID, Namespace.USER_COMMENTS.getLabel());
		NAMESPACE_CONVERSION_MAP.put(MEDIAWIKI_FILE_NAMESPACE_ID, Namespace.FILE.getLabel());
		NAMESPACE_CONVERSION_MAP.put(MEDIAWIKI_FILE_TALK_NAMESPACE_ID, Namespace.FILE_COMMENTS.getLabel());
		NAMESPACE_CONVERSION_MAP.put(MEDIAWIKI_MEDIAWIKI_NAMESPACE_ID, Namespace.JAMWIKI.getLabel());
		NAMESPACE_CONVERSION_MAP.put(MEDIAWIKI_MEDIAWIKI_TALK_NAMESPACE_ID, Namespace.JAMWIKI_COMMENTS.getLabel());
		NAMESPACE_CONVERSION_MAP.put(MEDIAWIKI_TEMPLATE_NAMESPACE_ID, Namespace.TEMPLATE.getLabel());
		NAMESPACE_CONVERSION_MAP.put(MEDIAWIKI_TEMPLATE_TALK_NAMESPACE_ID, Namespace.TEMPLATE_COMMENTS.getLabel());
		NAMESPACE_CONVERSION_MAP.put(MEDIAWIKI_CATEGORY_NAMESPACE_ID, Namespace.CATEGORY.getLabel());
		NAMESPACE_CONVERSION_MAP.put(MEDIAWIKI_CATEGORY_TALK_NAMESPACE_ID, Namespace.CATEGORY_COMMENTS.getLabel());
	}
