...
public final class MediaWikiConstants {
	...
	static final Map<Integer, Namespace> NAMESPACE_CONVERSION_MAP = new HashMap<Integer, Namespace>();
	static {
		NAMESPACE_CONVERSION_MAP.put(MEDIAWIKI_TALK_NAMESPACE_ID, Namespace.COMMENTS);
		NAMESPACE_CONVERSION_MAP.put(MEDIAWIKI_USER_NAMESPACE_ID, Namespace.USER);
		NAMESPACE_CONVERSION_MAP.put(MEDIAWIKI_USER_TALK_NAMESPACE_ID, Namespace.USER_COMMENTS);
		NAMESPACE_CONVERSION_MAP.put(MEDIAWIKI_FILE_NAMESPACE_ID, Namespace.FILE);
		NAMESPACE_CONVERSION_MAP.put(MEDIAWIKI_FILE_TALK_NAMESPACE_ID, Namespace.FILE_COMMENTS);
		NAMESPACE_CONVERSION_MAP.put(MEDIAWIKI_MEDIAWIKI_NAMESPACE_ID, Namespace.JAMWIKI);
		NAMESPACE_CONVERSION_MAP.put(MEDIAWIKI_MEDIAWIKI_TALK_NAMESPACE_ID, Namespace.JAMWIKI_COMMENTS);
		NAMESPACE_CONVERSION_MAP.put(MEDIAWIKI_TEMPLATE_NAMESPACE_ID, Namespace.TEMPLATE);
		NAMESPACE_CONVERSION_MAP.put(MEDIAWIKI_TEMPLATE_TALK_NAMESPACE_ID, Namespace.TEMPLATE_COMMENTS);
		NAMESPACE_CONVERSION_MAP.put(MEDIAWIKI_CATEGORY_NAMESPACE_ID, Namespace.CATEGORY);
		NAMESPACE_CONVERSION_MAP.put(MEDIAWIKI_CATEGORY_TALK_NAMESPACE_ID, Namespace.CATEGORY_COMMENTS);
	}
