...
<tr>
	...
	<td class="main-content">
		...
		<c:if test="${!empty pageInfo.redirectName}"><div id="contents-subheader"><f:message key="topic.redirect.from"><f:param><a href="<jamwiki:link value="${pageInfo.redirectName}" />?redirect=no"><c:out value="${pageInfo.redirectName}" /></a></f:param></f:message></div></c:if>
<c:choose>
