...
<form name="adminDelete" method="get" action="<jamwiki:link value="Special:Manage" />">
...
<form name="adminPermissions" method="get" action="<jamwiki:link value="Special:Manage" />">
<input type="hidden" name="<%= JAMWikiServlet.PARAMETER_TOPIC %>" value="<c:out value="${pageInfo.topicName}" />" />
<tr>
