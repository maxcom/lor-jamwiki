...
<tr>
	...
	<td class="formelement"><input type="text" name="<%= Environment.PROP_BASE_DEFAULT_TOPIC %>" value="<%= Environment.getValue(Environment.PROP_BASE_DEFAULT_TOPIC) %>" size="30" id="<%= Environment.PROP_BASE_DEFAULT_TOPIC %>" /></td>
</tr>
<tr>
	<td class="formcaption"><label for="<%= Environment.PROP_BASE_LOGO_IMAGE %>"><f:message key="admin.caption.logoimage" /></label></td>
	<td class="formelement"><input type="text" name="<%= Environment.PROP_BASE_LOGO_IMAGE %>" value="<%= Environment.getValue(Environment.PROP_BASE_LOGO_IMAGE) %>" size="30" id="<%= Environment.PROP_BASE_LOGO_IMAGE %>" /></td>
</tr>
<tr>
	<td class="formcaption"><label for="<%= Environment.PROP_TOPIC_VERSIONING_ON %>"><f:message key="admin.caption.useversioning" /></label></td>
	<td class="formelement"><input type="checkbox" name="<%= Environment.PROP_TOPIC_VERSIONING_ON %>" value="true"<%= Environment.getBooleanValue(Environment.PROP_TOPIC_VERSIONING_ON) ? " checked" : "" %> id="<%= Environment.PROP_TOPIC_VERSIONING_ON %>" /></td>
</tr>
<tr>
	...
	<td class="formelement"><input type="checkbox" name="<%= Environment.PROP_TOPIC_NON_ADMIN_TOPIC_MOVE %>" value="true"<%= Environment.getBooleanValue(Environment.PROP_TOPIC_NON_ADMIN_TOPIC_MOVE) ? " checked" : "" %> id="<%= Environment.PROP_TOPIC_NON_ADMIN_TOPIC_MOVE %>" /></td>
</tr>
<tr>
	<td class="formcaption"><label for="<%= Environment.PROP_TOPIC_FORCE_USERNAME %>"><f:message key="admin.caption.forceusername" /></label></td>
	<td class="formelement"><input type="checkbox" name="<%= Environment.PROP_TOPIC_FORCE_USERNAME %>" value="true"<%= Environment.getBooleanValue(Environment.PROP_TOPIC_FORCE_USERNAME) ? " checked" : "" %> id="<%= Environment.PROP_TOPIC_FORCE_USERNAME %>" /></td>
</tr>
<tr>
	<td class="formcaption"><label for="<%= Environment.PROP_IMAGE_RESIZE_INCREMENT %>"><f:message key="admin.caption.imageresize" /></label></td>
	<td class="formelement"><input type="text" name="<%= Environment.PROP_IMAGE_RESIZE_INCREMENT %>" size="5" maxlength="5" value="<%= Environment.getIntValue(Environment.PROP_IMAGE_RESIZE_INCREMENT) %>" id="<%= Environment.PROP_IMAGE_RESIZE_INCREMENT %>" /></td>
</tr>
<tr>
	<td class="formcaption"><label for="<%= Environment.PROP_RECENT_CHANGES_DAYS %>"><f:message key="admin.caption.recentchangesdefault" /></label></td>
	<td class="formelement"><input type="text" name="<%= Environment.PROP_RECENT_CHANGES_DAYS %>" size="3" maxlength="3" value="<%= Environment.getIntValue(Environment.PROP_RECENT_CHANGES_DAYS) %>" id="<%= Environment.PROP_RECENT_CHANGES_DAYS %>" /></td>
</tr>
<tr>
	<td class="formcaption"><label for="<%= Environment.PROP_TOPIC_USE_PREVIEW %>"><f:message key="admin.caption.usepreview" /></label></td>
	<td class="formelement"><input type="checkbox" name="<%= Environment.PROP_TOPIC_USE_PREVIEW %>" value="true"<%= Environment.getBooleanValue(Environment.PROP_TOPIC_USE_PREVIEW) ? " checked" : "" %> id="<%= Environment.PROP_TOPIC_USE_PREVIEW %>" /></td>
</tr>
<tr><td colspan="2">&nbsp;</td></tr>
...
<tr>
	...
	<td class="formelement"><input type="text" name="<%= Environment.PROP_PARSER_CLASS %>" value="<%= Environment.getValue(Environment.PROP_PARSER_CLASS) %>" size="50" id="<%= Environment.PROP_PARSER_CLASS %>" /></td>
</tr>
<tr>
	<td class="formcaption"><label for="<%= Environment.PROP_PARSER_TOC %>"><f:message key="admin.caption.tableofcontents" /></label></td>
	<td class="formelement"><input type="checkbox" name="<%= Environment.PROP_PARSER_TOC %>" value="true"<%= Environment.getBooleanValue(Environment.PROP_PARSER_TOC) ? " checked" : "" %> id="<%= Environment.PROP_PARSER_TOC %>" /></td>
</tr>
<tr>
	<td class="formcaption"><label for="<%= Environment.PROP_PARSER_ALLOW_HTML %>"><f:message key="admin.caption.allowhtml" /></label></td>
	<td class="formelement"><input type="checkbox" name="<%= Environment.PROP_PARSER_ALLOW_HTML %>" value="true"<%= Environment.getBooleanValue(Environment.PROP_PARSER_ALLOW_HTML) ? " checked" : "" %> id="<%= Environment.PROP_PARSER_ALLOW_HTML %>" /></td>
</tr>
<tr>
	...
	<td class="formelement"><input type="checkbox" name="<%= Environment.PROP_PARSER_ALLOW_JAVASCRIPT %>" value="true"<%= Environment.getBooleanValue(Environment.PROP_PARSER_ALLOW_JAVASCRIPT) ? " checked" : "" %> id="<%= Environment.PROP_PARSER_ALLOW_JAVASCRIPT %>" /></td>
</tr>
<tr>
	...
	<td class="formelement"><input type="text" name="<%= Environment.PROP_PARSER_SIGNATURE_USER_PATTERN %>" value="<%= Environment.getValue(Environment.PROP_PARSER_SIGNATURE_USER_PATTERN) %>" size="50" id="<%= Environment.PROP_PARSER_SIGNATURE_USER_PATTERN %>" /></td>
</tr>
...
<tr>
	...
	<td class="formelement"><input type="text" name="<%= Environment.PROP_PARSER_SIGNATURE_DATE_PATTERN %>" value="<%= Environment.getValue(Environment.PROP_PARSER_SIGNATURE_DATE_PATTERN) %>" size="50" id="<%= Environment.PROP_PARSER_SIGNATURE_DATE_PATTERN %>" /></td>
</tr>
...
<tr>
	...
	<td class="formelement"><input type="text" name="<%= Environment.PROP_EMAIL_SMTP_HOST %>" value="<%= Environment.getValue(Environment.PROP_EMAIL_SMTP_HOST) %>" size="30" id="<%= Environment.PROP_EMAIL_SMTP_HOST %>" /></td>
</tr>
<tr>
	<td class="formcaption"><label for="<%= Environment.PROP_EMAIL_SMTP_USERNAME %>"><f:message key="admin.caption.smtp.user" /></label></td>
	<td class="formelement"><input type="text" name="<%= Environment.PROP_EMAIL_SMTP_USERNAME %>" value="<%= Environment.getValue(Environment.PROP_EMAIL_SMTP_USERNAME) %>" size="30" id="<%= Environment.PROP_EMAIL_SMTP_USERNAME %>" /></td>
</tr>
<tr>
...
<tr>
	...
	<td class="formelement"><input type="text" name="<%= Environment.PROP_EMAIL_REPLY_ADDRESS %>" value="<%= Environment.getValue(Environment.PROP_EMAIL_REPLY_ADDRESS) %>" size="50" id="<%= Environment.PROP_EMAIL_REPLY_ADDRESS %>" /></td>
</tr>
...
<tr>
	...
	<td class="formelement"><input type="text" name="<%= Environment.PROP_BASE_FILE_DIR %>" value="<%= Environment.getValue(Environment.PROP_BASE_FILE_DIR) %>" size="50" id="<%= Environment.PROP_BASE_FILE_DIR %>" /></td>
</tr>
<tr>
...
<tr>
	...
	<td class="formelement"><input type="text" name="<%= Environment.PROP_DB_USERNAME %>" id="<%= Environment.PROP_DB_USERNAME %>" value="<%= Environment.getValue(Environment.PROP_DB_USERNAME) %>" size="30" /></td>
</tr>
<tr>
...
<tr>
	...
	<td class="formelement"><input type="text" name="<%= Environment.PROP_DBCP_MAX_ACTIVE %>" id="<%= Environment.PROP_DBCP_MAX_ACTIVE %>" value="<%= Environment.getIntValue(Environment.PROP_DBCP_MAX_ACTIVE) %>" size="5" /></td>
</tr>
<tr>
	<td class="formcaption"><label for="<%= Environment.PROP_DBCP_MAX_IDLE %>"><f:message key="admin.caption.dbcp.maxidle" /></label></td>
	<td class="formelement"><input type="text" name="<%= Environment.PROP_DBCP_MAX_IDLE %>" id="<%= Environment.PROP_DBCP_MAX_IDLE %>" value="<%= Environment.getIntValue(Environment.PROP_DBCP_MAX_IDLE) %>" size="5" /></td>
</tr>
<tr>
	...
	<td class="formelement"><input type="checkbox" name="<%= Environment.PROP_DBCP_TEST_ON_BORROW %>" id="<%= Environment.PROP_DBCP_TEST_ON_BORROW %>" value="true"<%= Environment.getBooleanValue(Environment.PROP_DBCP_TEST_ON_BORROW) ? " checked" : "" %> /></td>
</tr>
<tr>
	...
	<td class="formelement"><input type="checkbox" name="<%= Environment.PROP_DBCP_TEST_ON_RETURN %>" id="<%= Environment.PROP_DBCP_TEST_ON_RETURN %>" value="true"<%= Environment.getBooleanValue(Environment.PROP_DBCP_TEST_ON_RETURN) ? " checked" : "" %> /></td>
</tr>
<tr>
	...
	<td class="formelement"><input type="checkbox" name="<%= Environment.PROP_DBCP_TEST_WHILE_IDLE %>" id="<%= Environment.PROP_DBCP_TEST_WHILE_IDLE %>" value="true"<%= Environment.getBooleanValue(Environment.PROP_DBCP_TEST_WHILE_IDLE) ? " checked" : "" %> /></td>
</tr>
<tr>
	...
	<td class="formelement"><input type="text" name="<%= Environment.PROP_DBCP_MIN_EVICTABLE_IDLE_TIME %>" id="<%= Environment.PROP_DBCP_MIN_EVICTABLE_IDLE_TIME %>" value="<%= Environment.getIntValue(Environment.PROP_DBCP_MIN_EVICTABLE_IDLE_TIME) %>" size="5" /></td>
</tr>
<tr>
	...
	<td class="formelement"><input type="text" name="<%= Environment.PROP_DBCP_TIME_BETWEEN_EVICTION_RUNS %>" id="<%= Environment.PROP_DBCP_TIME_BETWEEN_EVICTION_RUNS %>" value="<%= Environment.getIntValue(Environment.PROP_DBCP_TIME_BETWEEN_EVICTION_RUNS) %>" size="5" /></td>
</tr>
<tr>
	...
	<td class="formelement"><input type="text" name="<%= Environment.PROP_DBCP_NUM_TESTS_PER_EVICTION_RUN %>" id="<%= Environment.PROP_DBCP_NUM_TESTS_PER_EVICTION_RUN %>" value="<%= Environment.getIntValue(Environment.PROP_DBCP_NUM_TESTS_PER_EVICTION_RUN) %>" size="5" /></td>
</tr>
<tr>
...
<tr>
	...
	<td class="formelement"><input type="text" name="<%= Environment.PROP_DBCP_VALIDATION_QUERY %>" id="<%= Environment.PROP_DBCP_VALIDATION_QUERY %>" value="<%= Environment.getValue(Environment.PROP_DBCP_VALIDATION_QUERY) %>" size="50" /></td>
</tr>
<tr>
	...
	<td class="formelement"><input type="checkbox" name="<%= Environment.PROP_DBCP_REMOVE_ABANDONED %>" id="<%= Environment.PROP_DBCP_REMOVE_ABANDONED %>" value="true"<%= Environment.getBooleanValue(Environment.PROP_DBCP_REMOVE_ABANDONED) ? " checked" : "" %> /></td>
</tr>
<tr>
	...
	<td class="formelement"><input type="text" name="<%= Environment.PROP_DBCP_REMOVE_ABANDONED_TIMEOUT %>" id="<%= Environment.PROP_DBCP_REMOVE_ABANDONED_TIMEOUT %>" value="<%= Environment.getIntValue(Environment.PROP_DBCP_REMOVE_ABANDONED_TIMEOUT) %>" size="5" /></td>
</tr>
...
<tr>
	...
	<td class="formelement"><input type="text" name="<%= Environment.PROP_USERGROUP_FACTORY %>" id="<%= Environment.PROP_USERGROUP_FACTORY %>" value="<%= Environment.getValue(Environment.PROP_USERGROUP_FACTORY) %>" size="50" /></td>
</tr>
<tr>
	<td class="formcaption"><label for="<%= Environment.PROP_USERGROUP_URL %>"><f:message key="admin.caption.usergroup.url" /></label></td>
	<td class="formelement"><input type="text" name="<%= Environment.PROP_USERGROUP_URL %>" id="<%= Environment.PROP_USERGROUP_URL %>" value="<%= Environment.getValue(Environment.PROP_USERGROUP_URL) %>" size="50" /></td>
</tr>
<tr>
	...
	<td class="formelement"><input type="text" name="<%= Environment.PROP_USERGROUP_USERNAME %>" id="<%= Environment.PROP_USERGROUP_USERNAME %>" value="<%= Environment.getValue(Environment.PROP_USERGROUP_USERNAME) %>" size="20" /></td>
</tr>
<tr>
...
<tr>
	...
	<td class="formelement"><input type="text" name="<%= Environment.PROP_USERGROUP_BASIC_SEARCH %>" id="<%= Environment.PROP_USERGROUP_BASIC_SEARCH %>" value="<%= Environment.getValue(Environment.PROP_USERGROUP_BASIC_SEARCH) %>" size="50" /></td>
</tr>
<tr>
	...
	<td class="formelement"><input type="text" name="<%= Environment.PROP_USERGROUP_SEARCH_RESTRICTIONS %>" id="<%= Environment.PROP_USERGROUP_SEARCH_RESTRICTIONS %>" value="<%= Environment.getValue(Environment.PROP_USERGROUP_SEARCH_RESTRICTIONS) %>" size="50" /></td>
</tr>
<tr>
	...
	<td class="formelement"><input type="text" name="<%= Environment.PROP_USERGROUP_USERID_FIELD %>" id="<%= Environment.PROP_USERGROUP_USERID_FIELD %>" value="<%= Environment.getValue(Environment.PROP_USERGROUP_USERID_FIELD) %>" size="20" /></td>
</tr>
<tr>
	...
	<td class="formelement"><input type="text" name="<%= Environment.PROP_USERGROUP_FULLNAME_FIELD %>" id="<%= Environment.PROP_USERGROUP_FULLNAME_FIELD %>" value="<%= Environment.getValue(Environment.PROP_USERGROUP_FULLNAME_FIELD) %>" size="20" /></td>
</tr>
<tr>
	...
	<td class="formelement"><input type="text" name="<%= Environment.PROP_USERGROUP_MAIL_FIELD %>" id="<%= Environment.PROP_USERGROUP_MAIL_FIELD %>" value="<%= Environment.getValue(Environment.PROP_USERGROUP_MAIL_FIELD) %>" size="20" /></td>
</tr>
<tr>
	...
	<td class="formelement"><textarea cols="40" rows="5" name="<%= Environment.PROP_USERGROUP_DETAILVIEW %>" id="<%= Environment.PROP_USERGROUP_DETAILVIEW %>"><%= Environment.getValue(Environment.PROP_USERGROUP_DETAILVIEW) %></textarea></td>
</tr>
<!-- END USERGROUP-TYPE -->
