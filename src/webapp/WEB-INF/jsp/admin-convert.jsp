...
<c:if test="${!empty messageObject}"><div class="message red"><f:message key="${messageObject.key}" /></div></c:if>
<c:if test="${!empty message}"><div class="message green"><f:message key="${message.key}" /></div></c:if>
