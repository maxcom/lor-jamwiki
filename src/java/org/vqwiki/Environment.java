...
public class Environment {
	...
	public static final String PROP_TOPIC_ALLOW_VWIKI_LIST = "allow-vqwiki-list";
	...
	private static final String PROPERTY_FILE_NAME = "vqwiki.properties";
	...
	private static void initDefaultProperties() {
		...
		defaults.setProperty(PROP_DB_PASSWORD, "vqwiki");
		defaults.setProperty(PROP_DB_TYPE, "mysql");
		defaults.setProperty(PROP_DB_URL, "jdbc:mysql://localhost/vqwiki");
		defaults.setProperty(PROP_DB_USERNAME, "vqwiki");
		...
		defaults.setProperty(PROP_EMAIL_REPLY_ADDRESS, "vqwiki-admin@localhost");
		...
		defaults.setProperty(PROP_RECENT_CHANGES_DAYS, "5");
